...
export const filters = [
  {
    ...
    config: {
      ...
      options: [
        ...
        { key: 'art-nouveau', label: 'Art Nouveau' },
        { key: 'bohemian', label: 'Bohemian' },
        { key: 'coastal & Tropical', label: 'Coastal & Tropical' },
        { key: 'colonial', label: 'Colonial' },
        { key: 'contemporary', label: 'Contemporary' },
        { key: 'country-and-farmhouse', label: 'Country and Farmhouse' },
        { key: 'industrial', label: 'Industrial' },
        { key: 'lodge', label: 'Lodge' },
        { key: 'minimalist', label: 'Minimalist' },
        { key: 'craftsman', label: 'Craftsman' },
        { key: 'rustic', label: 'Rustic' },
        { key: 'scandanavian', label: 'Scandanavian' },
        { key: 'shaker', label: 'Shaker' },
        { key: 'southwestern', label: 'Southwestern' },
