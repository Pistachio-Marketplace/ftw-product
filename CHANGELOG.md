...
- [change] Update translations (en.json) to match Pistachio concept.
...
- [change] Social media images updated for Pistachio.
  [#72](https://github.com/sharetribe/ftw-product/pull/72)
- [change] Marketplace colors updated for Pistachio.
